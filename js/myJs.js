//Populate overlay
      ...
      var artWebObj = new content( " Artist Website","This website was created to showcase artists work and skills in following technologies used:",['Bootstrap','HTML5', 'CSS3', 'JavaScript', 'jQuery'],['https://artist.sharondesmond.com','https://github.com/Mathemagiks/Artist-Website.git']);
      var artWebAppObj = new content("Artist Website/Webstore", "This website was created to showcase artists work and present webstore that can take in mock credit card data, implement registration/login/logout using the following technologies:", ['Bootstrap','HTML5', 'CSS3', 'JavaScript', 'jQuery', 'PHP', 'MySQL', 'AJAX'], ['https://artist-portfolio.sharondesmond.com/','https://github.com/Mathemagiks/Artist-Website-Webstore.git']);
